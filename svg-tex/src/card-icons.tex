...
\begin{tikzpicture}[icon]
  ...
  % A compact flag-variety/Grassmannian icon: nested subspaces and a
  % highlighted Schubert condition.
  \draw[black, thinner] (-0.72,-0.55) -- (0.72,-0.55);
  \draw[black, thinner] (-0.55,-0.15) -- (0.62,-0.15);
  \draw[black, thinner] (-0.33,0.25) -- (0.46,0.25);

  \filldraw[iconblue, draw=black]
    (-0.05,-0.55) -- (0.45,-0.15) -- (0.18,0.25) -- (-0.32,-0.15) -- cycle;

  \node[node-blue] at (-0.32,-0.15) {};
  \node[node-blue] at (0.45,-0.15) {};
  \node[node-blue] at (0.18,0.25) {};

  \draw[black, thinner, dashed] (-0.7,0.55) -- (0.72,-0.72);
  \node[node-black] at (-0.05,-0.05) {};
\end{tikzpicture}
...
\begin{tikzpicture}[icon]
  ...
  % Three stacked bases/layers in the symmetric-function ring.
  \foreach \y in {-0.42,-0.03,0.34} {
    \fill[iconblue] (-0.72,\y-0.18) rectangle (0.72,\y+0.18);
    \fill[iconblue] (0,\y+0.18) ellipse [x radius=0.72, y radius=0.18];
    \draw[black, thinner] (-0.72,\y-0.18) -- (-0.72,\y+0.18);
    \draw[black, thinner] (0.72,\y-0.18) -- (0.72,\y+0.18);
    \draw[black, thinner] (0,\y-0.18) ellipse [x radius=0.72, y radius=0.18];
    \draw[black, thinner] (0,\y+0.18) ellipse [x radius=0.72, y radius=0.18];
  }
\end{tikzpicture}
