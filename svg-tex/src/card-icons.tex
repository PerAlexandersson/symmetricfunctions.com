...
\begin{tikzpicture}[icon]
  ...
  \node[text=iconblue, font=\boldmath\fontsize{32}{32}\selectfont] at (0,0)
    {$\mathfrak{S}_w$};
\end{tikzpicture}


\tikzsetnextfilename{card-backStableSchubert}
\begin{tikzpicture}[icon]
  \cardframe

  \node[text=iconblue, font=\boldmath\fontsize{27}{27}\selectfont] at (0,0)
    {$\overleftarrow{\mathfrak{S}}_w$};
\end{tikzpicture}
...
\begin{tikzpicture}[icon]
  ...
  \node[text=iconblue, font=\boldmath\fontsize{70}{70}\selectfont] at (0,0)
    {$K$};
\end{tikzpicture}
...
\tikzsetnextfilename{card-rowmotionPromotion}
\begin{tikzpicture}[icon]
  \cardframe

  % A three-element poset together with a cyclic action.
  \coordinate (a) at (-0.48,-0.48);
  \coordinate (b) at (0.48,-0.48);
  \coordinate (c) at (0,0.38);
  \draw[black!60, line width=0.7mm] (a) -- (c) -- (b);
  \node[node-blue] at (a) {};
  \node[node-blue] at (b) {};
  \node[node-black] at (c) {};
  \draw[iconblue, ->, >=stealth, line width=0.75mm]
    (0.45,0.52) arc (25:155:0.50);
\end{tikzpicture}


\tikzsetnextfilename{card-about}
\begin{tikzpicture}[icon]
  \cardframe

  % Atom-like cue for site background and project information.
  \begin{scope}[line width=0.65mm]
    \draw[iconblue] (0,0) ellipse (0.62 and 0.2);
    \draw[iconblue, rotate=60] (0,0) ellipse (0.62 and 0.2);
    \draw[iconblue, rotate=-60] (0,0) ellipse (0.62 and 0.2);
  \end{scope}
  \node[node-blue, minimum size=8pt] at (0,0) {};
  \node[node-black, minimum size=5pt] at (0.62,0) {};
  \node[node-black, minimum size=5pt] at (-0.31,0.54) {};
  \node[node-black, minimum size=5pt] at (-0.31,-0.54) {};
\end{tikzpicture}
