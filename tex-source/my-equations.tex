...
\section[myEquationsCatalan]{$q$-Catalan refinement}
...
\section[myEquationsLltE]{Unicellular LLT $e$-expansion}

I conjectured, and a few years later together with \name{Robin Sulzgruber}
...
\section[myEquationsBSD]{Border-strip decompositions of a rectangle}
...
\section[myEquationsCircularDyck]{Circular Dyck diagrams}
...
\section[myEquationsJackKostka]{Normalized Jack--Kostka coefficients}
...
This equation allows us to see that $\mathfrak{K}_{(k)}^{(\alpha)}(\mathbf{r}^{\mathbf{p}})$
