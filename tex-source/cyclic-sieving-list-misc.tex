...
\section[cspListMisc]{Miscellaneous}
...
rowmotion operator (a.k.a. the 'Fon-Der-Flaass/Panyushev map') on the antichains of $\Phi^+$.
...
of rowmotion on height $m$ $P$-partitions of a poset $P$.
...
root poset 'of coincidental type', where the sieving polynomial is
the so-called '$q$-$\Phi$-multi-Catalan number'.
...
B. Rhoades further generalizes this to matrices with non-negative integer entries, and prove 
a bi-cyclic phenomenon using
\[
...
and crystals, generalizing the promotion CSP by Rhoades.
...
the $q$-analogue of the Ehrhart function of $P$, defined as
\[
...
A. Mason, V. Reiner and S. Sridhar have some results on 
