...
\name[Per Alexandersson]{Alexandersson} and \name[Robin Sulzgruber]{Sulzgruber} \cite{AlexanderssonSulzgruber2019} 
...
by \name{R. Liu} and \name{M. Weselcouch} \cite[Thm. 6.9]{LiuWeselcouch2020}, 
where a signed rule is proved. 
This rule coincides with the \hyperref[skewSchurMurnaghanNakaygama]{classical Murnaghan--Nakayama rule} 
...
\name{S. Assaf} and \name{N. Bergeron} \cite{AssafBergeron2019} consider a flagged version of $(P,w)$-partitions.
