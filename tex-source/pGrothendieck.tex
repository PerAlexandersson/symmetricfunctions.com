...
$x_1,x_2$.  The degree-four part comes from shifted multiset tableaux in
$\mathrm{SMT}_0(21)$ with exactly one extra entry beyond the three boxes of
the shifted shape.  There are eight such tableaux, and their weights give
\[
\left[\deg_{\xvec}=4\right]
\grothendieckPDual_{21}(x_1,x_2;t_1,t_2)
= (t_1+t_2)
...
Here $t_i$ records the shifted diagonal in which the extra entry appears.
\end{example*}
