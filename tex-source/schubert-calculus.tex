...
\metadescription{A computation-focused introduction to Schubert calculus on Grassmannians, including Schubert classes, Pieri and Giambelli formulas, and enumerative examples.}

\section[schubertCalculus]{Schubert calculus}

\defin{Schubert calculus} is the use of Schubert varieties and their
intersection products to solve enumerative problems.  In the most classical
case, this means computing in the cohomology ring of a Grassmannian.  The
combinatorics is governed by partitions, Young diagrams, Schur polynomials,
Pieri rules, Giambelli determinants, and
...
\cite{Gillespie2019}, which is adapted from her
\href{https://www.mathematicalgemstones.com/gemstones/sapphire/schubert-calculus-mini-course/}
...
\defin{Grassmannian} $\operatorname{Gr}(k,V)$, often written
...
\[
  ...
  \qquad \dim F_i=i.
\]
Schubert classes in $\operatorname{Gr}(k,n)$ are indexed by partitions
$\lambda$ fitting in the $k\times(n-k)$ rectangle:
\[
  n-k\geq \lambda_1\geq \lambda_2\geq\dotsb\geq\lambda_k\geq 0.
\]
The corresponding \defin{Schubert variety} is
\[
...
terms which do not define classes in the Grassmannian.
...
Schubert calculus on the complete flag variety is indexed by permutations
...
For the full flag variety in $\setC^3$, the six Schubert polynomials are
\[
\begin{array}{c|c}
