...
Schubert varieties and their intersection products to solve enumerative
problems.  In the most classical case, this means computing in the cohomology
ring of a \hyperref[grassmannian]{Grassmannian}.  The combinatorics is governed
by partitions, Young diagrams, \hyperref[schurS]{Schur polynomials},
