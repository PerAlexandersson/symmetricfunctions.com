...
\name{Jinren Dou}, \name{Neil J. Y. Fan}, and \name{Kunwen Liu} characterize
when a Schubitope is \defin{lattice-free}, meaning that its only lattice
points are its vertices \cite{DouFanLiu2026x}.  This is equivalent to its
Ehrhart polynomial factoring as the product of the Ehrhart polynomials of the
column Schubert-matroid polytopes.  For Schubert and Grothendieck Newton
polytopes, lattice-freeness is characterized by avoidance of
$1423,1432,13254$, and the result settles support conjectures for this class.
...
are \hyperref[generalizedPermutohedron]{generalized permutohedra}
\cite[Cor.~1.3]{AnTungZhang2024x}.  They also give a combinatorial
description of the vertices of these Newton polytopes.
