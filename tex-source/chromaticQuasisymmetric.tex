...
In Spring 2016, \name{B. Ellzey} \cite{Ellzey2017} presented a generalization where labeled graphs are replaced with \emph{oriented graphs}.
This new model is equivalent to the Shareshian--Wachs model when the orientation of the edges has no directed cycle.
See also  \name{G. Panova}, \name{P. Alexandersson} \cite{AlexanderssonPanova2018}, who considered the same model from a different perspective.
...
and later the refined conjecture by \name{J. Shareshian} and \name{M. Wachs} in \cite{ShareshianWachs2012,ShareshianWachs2016}.
...
In \cite{Hwang2022x}, \name{Byung-Hak Hwang} introduces an additional refinement on the chromatic quasisymmetric functions.
...
If $G$ is a claw-free graph, \name{Gasharov} (see \cite{Stanley1998}) conjecture that $\chrom_G(\xvec;1)$ is Schur-positive.
...
\name{O. Bernardi} and \name{P. Nadeau} \cite{BernardiNadeau2020} gave the following interpretation of
...
The relationship is reminiscent of the technique introduced by \name{Haglund}, \name{Haiman} and \name{Loehr} \cite{HaglundHaimanLoehr2005}.

This plethystic relationship is generalized in \cite[Thm. 6.2]{NovelliThibon2019},
where a non-commutative lift is given. \name{J.-C. Novelli} and \name{J.-Y. Thibon} also introduce 
...
was conjectures.
This conjecture was resolved in in 2015, where \name{Brosnan} and \name{Chow} proved that for unit-interval graphs $\avec$, 
