...
such that $i \leq m_i \leq n$. These are in bijection with area sequences of unit interval graphs, via $a_i = m_i - i$.
...
\begin{example}
The area sequence $(0,1,2,1,1)$ corresponds to the Hessenberg sequence $(2,3,5,5,5)$.
...
where $\symS_n$ acts on a certain polynomial ring defined via $MG(\avec)$.
