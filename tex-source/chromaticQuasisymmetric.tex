...
\name{R. Stanley} conjectures \cite{Stanley1995} that the chromatic symmetric function of a tree, 
...
The work by \name{Hasabe} and \name{Tsujie} is continued in \cite{Zhou2020x},
...
The chromatic symmetric functions for certain \enquote{spider graphs} are shown to be Schur positive in \cite{ThibonWang2023x}.
...
the \name{Tymoczko} cells of the corresponding regular nilpotent Hessenberg variety, see \cite{NovelliThibon2024x}.
