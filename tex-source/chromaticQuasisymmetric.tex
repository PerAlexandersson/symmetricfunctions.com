...
\begin{conjecture}[Shareshian--Wachs (2012)]
Let $G$ be a unit interval graph. 
Find a statistic $\mu$ on acyclic orientations of $G$,
such that
\[
...
According to \name{Anton Mellit} (personal communication), 
...
\subsection[chromaticEExpansionCurrentStatus]{Current status of the Stanley--Stembridge/Shareshian--Wachs conjecture}
...
This corresponds to area sequences of the form $(0,1,2,2,\dotsc,2)$.
\item 
