...
The cyclic group $\grpc_n$ acts on $X$ by cyclic shift, and let
\[
...
It was pointed out to me by \name{Sam Hopkins} that this also follows from \cite{RushShi2012},
...
equivalent with rotation of the webs.
