...
Kreweras words of length $3n$ \cite{HopkinsRubey2021}.  These are in bijection
with linear extensions of a certain poset, and also with so-called Kreweras
webs.  The group action is promotion in the linear extensions, which is
equivalent to rotation of the webs.
