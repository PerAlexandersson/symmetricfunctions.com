...
See also \cite{AyyerKumari2022,Albion2022}, where Lie group characters of type $A$, $B$, $C$ and $D$
...
In \cite{Albion2022}, one notes that the algebra homomorphism $\phi_r$ that sends $\completeH_j$ to $\completeH_{j/r}$
...
The above theorem by Lee--Oh can then be lifted to the symmetric functions level, see \cite{Albion2022}.
