...
provides nice $q$-binomial formulas in the case of two-row skew shapes.
...
Furthermore, let $\SYT(\alpha)$ be the set of \emph{ribbon \hyperref[prelimTableaux]{standard Young tableaux}}
