...
\defin{Kashiwara--Nakashima tableaux} carry a
...
The \defin{orthogonal Schur functions} can be expressed as a sum of skew Schur functions as
\[
...
\defin{strict partitions}, that is, partitions with distinct parts, and are given
...
Schur's $Q$ functions $\schurQ_\lambda(\xvec)$ are indexed by strict partitions
and are given
