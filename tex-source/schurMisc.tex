...
$U_q(\mathfrak{sp}(2m,\setC))$-crystal structure; see
...
There are analogues of Gelfand--Tsetlin patterns for these functions, see e.g.
...
For shifted tableau switching and related evacuation operations, see
\cite{ChoiNamOh2017x}.
