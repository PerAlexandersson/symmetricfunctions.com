...
tableaux to standard and semistandard Young tableaux, and identify the count
with a coefficient in a Schur expansion of
$\schurS_\lambda(m+y_1,\dotsc,m+y_n)$.

\todo{Later examples pass: add a small lecture hall tableau example and, if needed, write Rust code to generate/check bounded lecture hall tableaux.}
