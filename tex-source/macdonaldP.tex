...
- SpecializesTo macdonaldP -> elementaryE; from polynomialData.m, tikzdataRelations.txt.
- Misc macdonaldP -> macdonaldJ; from polynomialData.m, tikzdataRelations.txt.
}
...
\todo{Later relation pass: revisit vector-valued Macdonald/Jack and the $(q,q^2)$ finite-field specialization for possible family nodes, specialization metadata, and small computed examples.}
...
\todo{Legacy relation hints from old polynomialData.m/tikzdata*.txt to verify or migrate:
- Misc macdonaldJ -> macdonaldH; from polynomialData.m, tikzdataRelations.txt.
}
