...
the Dyck path, and the dimension of its base polytope is the number of non-zero
...
interlacing recurrence \cite{BraunJal2026x}; equivalently, these order
polytopes have real-rooted $h^*$-polynomials.
