...
there is a natural correspondence between area sequences and Dyck paths in $\DP(n)$.
...
Another $q$-analog of the above identity is due to \name{Adriano Garsia} and \name{Jeffrey Remmel}, \cite{GarsiaRemmel1986},


\subsection[aoMacdonald]{Macdonald polynomials}

In \cite[Prop. 5.9]{AlexanderssonUhlin2020} \name{Joakim Uhlin} and I prove that
\[
[\monomial_{1^{2n}}] \macdonaldE_{(n,n)}(\xvec;q,0) = [n]_q! T_n(q).
\]
This formula appears as a conjecture in \cite{Uhlin2019}.
