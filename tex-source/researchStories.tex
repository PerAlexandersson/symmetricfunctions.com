...
\metadescription{Stories about solving a problem or finding a pattern.}


\section[researchStoryTable]{Big table of data}
...
that this might be related to the celebrated Pascal's triangle.
I tried to subtract various versions of Pascal's triangle from the entries, but not much luck.
...
\subsection[researchStoryLinrec]{Method}
