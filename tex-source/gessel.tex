...
\metadescription{An introduction to Gessel quasisymmetric functions, including their definition, properties, product rules, specializations, and relationships with other bases such as the powersum basis and quasisymmetric powersum basis.}  
\metakeywords{Gessel quasisymmetric functions,fundamental quasisymmetric functions,product rule,specializations,powersum basis,quasisymmetric powersum basis}
...
\end{equation*}
where $\leq$ is the refinement partial order.
...
By using determinant formulas, the compositions can be "straightened" into partitions, 
