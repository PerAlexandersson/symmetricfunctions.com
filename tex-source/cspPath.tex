...
\subsection[cspFansOfDyckPaths]{Fans of Dyck paths}

\name{Joseph Pappe}, \name{Stephan Pfannerer}, \name{Anne Schilling}, and
\name[Mary Claire Simone]{Mary Claire Simone} study promotion on $r$-fans of
Dyck paths and on vacillating tableaux \cite{PappePfannererSchillingSimone2024}.
They construct an injection into chord diagrams that intertwines promotion with
rotation, using promotion-evacuation diagrams and Fomin growth diagrams.  This
gives cyclic sieving phenomena for $r$-fans of Dyck paths and for the
corresponding vacillating tableaux.
...
and this seems to suggest a cyclic sieving under $\grpc_n$.
