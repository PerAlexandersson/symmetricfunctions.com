...
In \cite[Cor.~5.4.8]{Lothaire2002}, one finds the following
...
\hyperref[kostkaFoulkes]{charge} equal to zero.
...
there are at most as many entries $\ell+1$ on the left-hand side as entries
$\ell$.
...
In \cite[Thm.~5.1]{GaoOrelowitzYong2020x}, a polytope description for
$N_{\mu,\nu,\lambda}$ is given,
...
polynomial above has non-negative coefficients.
...
In \cite{Shrivastava2022x}, \name{Sagar Shrivastava} shows how one can
compute Littlewood--Richardson coefficients as a signed sum of Kostka
coefficients.

It is known that (skew) Kostka coefficients can be obtained as a
