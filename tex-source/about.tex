...
\href{http://www.mat.uc.pt/~oazenhas/}{Olga Azenhas},
\href{https://www.cip.ifi.lmu.de/~grinberg/index.html}{Darij Grinberg},
\href{http://www-users.math.umn.edu/~shopkins/}{Sam Hopkins},
\href{http://wwwmathlabo.univ-poitiers.fr/~maavl/}{Marc van Leeuwen}
and 
\href{https://www.math.miami.edu/~wachs/}{Michelle Wachs}.
...
and I use \href{https://fontawesome.com/}{FontAwesome} for icons.
It is my intention to keep the website mobile friendly as about $30\%$ of the users access
the page using a phone.

Any suggestions of improvements are welcome.


% 
% \subsection[referencesHere]{In the press}
% 
% The Symmetric functions catalog has been referenced in the following articles.
...
% 
% \todo{
% SymCat is mentioned in 
% \cite{Grinberg2020x}
% \url{https://arxiv.org/pdf/2012.02376.pdf}
% \url{http://www-math.mit.edu/~rstan/ec/ch7suppsol.pdf}
% }
