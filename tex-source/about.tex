...
(FPSAC), back in 2011.
There is a plethora of generalizations of \hyperref[schurFunction]{Schur functions}
and somewhere I decided that
I wanted a good overview of all the definitions, relations and results.
The project is very much inspired by \emph{Schur functions: Theme and variations} by \name{Ian Macdonald} \cite{Macdonald1992}.
...
I then decided to put it online. Note that I am biased towards research I am more familiar with.

Please send me an email if you find this page useful or have any feedback.


\subsection[aboutContributions]{Contributions}
...
\subsection[aboutContent]{Content}
...
\subsection[aboutWebpage]{Website}
...
I have used AI extensively to develop this build process.
The full code is available on \href{https://github.com/PerAlexandersson/symmetricfunctions.com}{\icon{github} GitHub}.

There is also a sister site, \href{https://www.arxiv.symmetricfunctions.com}{arXiv Companion}, which provides a curated overview of recent arXiv preprints related to symmetric functions and algebraic combinatorics.
...
I host this web page on \href{https://inleed.se/}{Inleed.se}, a Swedish web hosting service with excellent customer support.
The running yearly cost is about:
\begin{itemize}
 \item Web server (space): 60 USD.
 \item Domain name: 20 USD.
\end{itemize}

If you use the site and want to help cover these running costs, you can use
\href{https://ko-fi.com/W7W41VN3WK}{this donation link}.
