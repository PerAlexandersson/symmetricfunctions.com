...
coming from moments of permutation-pattern counts \cite{GaetzPierson2022x}.
For identity patterns, they verify several cases of a positivity conjecture by
showing that the corresponding coefficient polynomials are real-rooted with
all roots below the pattern length.
