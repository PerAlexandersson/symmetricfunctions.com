...
\begin{equation*}\label{eq:keyExample}
\begin{split}
\key_{\lambda,\sigma}(z) &=
z_1^2 z_2  + 
z_1^2 z_3  + 
...
\begin{align}\label{eq:keyGTFormula}
...
From the work of S. Mason \cite{Mason2009}, 
...
an \hyperref[rsk]{Robinson--Schensted--Knuth}-type algorithm is given by S. Assaf and D. Quijada in \cite{AssafQuijada2019x}.
...
and show that these are positive in the key basis. They use weak dual equivalence 
to obtain their result. 
This generalizes an earlier result by Reiner and Shimozono, \cite{ReinerShimozono1995}.
...
\begin{polydata}{atom}
  ...
  Keywords & divided-difference, fillings, polytopes \\
  Category & Schur \\
\end{polydata}
...
See Anna Pun's thesis for a good 
overview of Demazure atoms, key polynomials and recent results \cite{Pun2016Thesis}.
...
by O. Azenhas and A. Emami in \cite{AzenhasEmami2015}. 
They use a version of RSK introduced by S. Mason in \cite{Mason2008}.
...
RSK, crystals and last passage percolation.
...
In \cite{FuLascoux2009}, A. Fu and A. Lascoux define divided difference operators
...
They end with an open question about how to characterize type $B$ Demazure atoms
as a sum over fillings.  This question is perhaps answered in the recent preprint
\url{https://arxiv.org/pdf/1910.14115.pdf}.
...
\todo{Add type BC keys and atoms}


In \cite{Santos2021}, J. M. Santos gives combinatorial formulas 
for the type $C$ key polynomials and Demazure atom polynomials.
