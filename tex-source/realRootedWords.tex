...
For descent polynomials of linear extensions of posets, including
...
polynomials; they prove several cases for order $2$.
\end{example*}
...
and since the right-hand side vanishes at $s=i$, $t = 2+i$,
...
where we sum over all \hyperref[namedPermutations]{simsun permutations}.
