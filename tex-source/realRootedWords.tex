...
\]
The coefficients of $D_n(t)$ form \oeis{A333829}; the first examples are
\[
...
\]
To prove that the word polynomial is real-rooted, let $F_{r,j}(t)$ enumerate
the words in $[m]^r$ ending in $m+1-j$.  Appending the final letter gives
\[
 F_{1,j}(t)=1,\qquad
 F_{r+1,j}(t)
...
Consequently, $F_{r,1},\dotsc,F_{r,m}$ have a common interlacing, so their sum
$W_{r,m}(t)$ is real-rooted.  The displayed transfer identity now proves the
claim.
\end{example*}
