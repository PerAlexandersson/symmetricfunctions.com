...
\emph{The following definition has not been defined in any publication to my knowledge.
This is possibly related or equivalent with the notion of a universal CSP statistic.
 --- Per}
...
The term \defin{homomesy} was introduced by \name{Jim Propp} and \name{Tom Roby} in \cite{ProppRoby2013x} is defined as follows.
