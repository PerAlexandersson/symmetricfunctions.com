...
\begin{figure}
    \svgimg[width=0.12\textwidth]{svg-images/6-vertex-model-1.svg}{An admissible local labelings for the 6-vertex model.}
    \svgimg[width=0.12\textwidth]{svg-images/6-vertex-model-2.svg}{An admissible local labelings for the 6-vertex model.}
    \svgimg[width=0.12\textwidth]{svg-images/6-vertex-model-3.svg}{An admissible local labelings for the 6-vertex model.}
    \svgimg[width=0.12\textwidth]{svg-images/6-vertex-model-4.svg}{An admissible local labelings for the 6-vertex model.}
    \svgimg[width=0.12\textwidth]{svg-images/6-vertex-model-5.svg}{An admissible local labelings for the 6-vertex model.}
    \svgimg[width=0.12\textwidth]{svg-images/6-vertex-model-6.svg}{An admissible local labelings for the 6-vertex model.}
\end{figure}
...
a new family of symmetric functions, which unify 
unify \hyperref[qWhittaker]{$q$-Whittaker polynomials}, inhomogeneous $q$-Whittaker polynomials, 
