...
Schur functions were first studied by \name{Augustin-Louis Cauchy} in \cite{Cauchy1815},
where he defined the Schur functions as a ratio of alternants, and proving that these are symmetric.
Later, \name{Carl Jacobi} \cite{Jacobi1841} gave the definition of Schur polynomials via Cauchy's bialternant formula
...
Jacobi--Trudi identities for skew Schur polynomials from the BGG category
...
Given any \emph{outside decomposition} $(\theta_1,\dotsc,\theta_m)$ of $\lambda/\mu$,
one has
\[
