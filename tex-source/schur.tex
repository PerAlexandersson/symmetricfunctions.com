...
specializations, excited diagrams, non-intersecting lattice paths, and
...
from elliptically weighted non-intersecting lattice paths
...
Schur-function case in his FPSAC 2015 slides
\href{https://vferay.perso.math.cnrs.fr/Slides/Feray_FPSAC2015.pdf}
...
and are closely related to the theory of
\hyperref[planePartitions]{plane partitions}.
Identity two and three below are due to \name{Dudley Littlewood}.
...
\]
\name{Julius Ross} and \name{Kuang-Yu Wu} conjecture a Schur-positive
...
\href{https://people.sissa.it/~dubrovin/Papers/2015/Dubrovin_2015.pdf}{in
this paper}.  In this setting the first nontrivial Hamiltonian is the
