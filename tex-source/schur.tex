...
the initial diagonal of $\theta_i$ and ends on the terminal diagonal of
$\theta_j$, with the usual empty and zero conventions from
...
\todo{Add detailed Hamel--Goulden examples.  In particular, include an
outside decomposition, the associated cutting strip, and the resulting
determinant.  Do not hand-draw TikZ diagrams unless they have been checked
against the paper or generated from a reliable diagram routine.}
