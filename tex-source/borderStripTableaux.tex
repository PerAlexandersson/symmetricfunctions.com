...
\todo{Add this extremely efficient recursion for character values.
...
\begin{figure}
<img src="./svg-images/k-ribbon2211-1111.svg" alt="The 6 3-ribbon tableaux with shape 4422 and weight 1111." style="width:80%; margin:5px;"/>
\end{figure}

The following figure shows the elements in $\SSYT^{(3)}(4422,211)$.
\begin{figure}
<img src="./svg-images/k-ribbon2211-211.svg" alt="The 3 3-ribbon tableaux with shape 4422 and weight 211." style="width:40%; margin:5px;"/>
\end{figure}
\end{example*}
...
\begin{figure}
<img src="./svg-images/partition-quotient.svg" alt="A partition and the 3-quotient" style="width:40%; margin:5px;"/>
\ytableaushort{{\;}{\;}{\;},{\;}{\;}{\;}}
\ytableaushort{{\;}{\;}}
\ytableaushort{{\;}{\;},{\;},{\;}}
\end{figure}
...
\begin{figure}
<img src="./svg-images/border-strip-example.svg" alt="A border-strip tableau with stips of size 3" style="width:30%; margin:5px;"/>
\ytableaushort{138,2{11}{12}}
\ytableaushort{67}
\ytableaushort{49,5,{10}}
\end{figure}
