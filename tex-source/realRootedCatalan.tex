...
This page collects real-rootedness results from Catalan combinatorics: Dyck
paths, ballot sequences, Motzkin paths, and related families.  Many examples
below are \hyperref[sturmSequence]{Sturm sequences}, so consecutive
polynomials interlace and every polynomial in the sequence is real-rooted.
...
non-negative coefficient cones.
...
\]
or, \texttt{HypergeometricPFQ[{-n, -n - 1}, {2}, t]},
see \cite[Sec. 12]{BarryHennessy2011}.
