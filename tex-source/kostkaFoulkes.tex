...
using the Ram--Yip formula for Macdonald polynomials and the quantum Bruhat
order \cite{Lenart2011x}.  In type $A$ this recovers the usual charge, while in
type $C$ it gives a new charge-like statistic.
