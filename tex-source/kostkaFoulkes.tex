...
permutations with prescribed longest increasing subsequence behavior
...
is given in \cite{EgeciogluRemmel1990}. The formula is based on the combinatorial model using
\hyperref[kostkaInverseModel]{special rim hook tabloids}.
...
of \defin{cyclage}. Let $\mu$ be a partition,
...
There is a $q$-analogue of this in the case $\nu=1^n$, see \cite[Corollary 1.3]{Kirillov2000}.
\[
...
The quantum Kostka coefficients arise in the study of the
quantum cohomology of the Grassmannian, \cite{PetrovicRadovanovic2016}.
...
and Hall--Littlewood bases, and for point counts on unipotent partial flag
varieties \cite{Kirillov2000}.  The same paper reviews $q$-analogues of
