...
described. In fact, it generalizes to Jack polynomials.
\begin{theorem}
...
and $K_{\lambda, \mu}=0$ unless $\lambda \geq \mu$ in dominance order.
\end{theorem}
...
this \href{https://github.com/PerAlexandersson/Mathematica-packages/blob/master/CombinatoricsUtil.m}{github file}.
...
See Harris, Insko and Omar \cite{HarrisInskoOmar2018} for a short introduction.
...
This has a close relationship with the Jacobi--Trudi identity, see
...
A similar expression for the Schur P structure 
...
attributes the following formula to B. Kostant:
...
However, we have the stronger statement, due to Derksen and Weyman \cite{DerksenWeyman2002}:
\begin{theorem}
...
Flagged skew Kostka coefficients can be expressed using contingency tables.
...
\begin{figure}
\begin{ytableau} 1&1&1&4\\2&2\\3 \end{ytableau} 
\begin{ytableau} 1&1&1&3 \\ 2&2\\ 4 \end{ytableau} 
\begin{ytableau} 1&1&1&2 \\ 2&4\\ 3 \end{ytableau}
\begin{ytableau} 1&1&1&2 \\ 2&3\\ 4 \end{ytableau}
\end{figure}
...
In \cite{LascouxSchutzenberger1981}, Lascoux and Schützenberger introduce 
...
\begin{figure}
<img src="./svg-images/cyclagePoset.svg" alt="Cyclage poset" 
style="width:40%; min-width:10em; margin-right:15px;margin-left:15px;"/>
\end{figure}
\end{example*}
...
\begin{example*}[Figure of catabolism (poset)]
The charge is displayed on the right hand side of each tableau.
\begin{figure}
<img src="./svg-images/catabolism.svg" alt="Catabolism" 
style="width:90%; min-width:10em; margin-right:15px;margin-left:15px;"/>
\end{figure}
\end{example*}
...
\url{http://fpsac2019.fmf.uni-lj.si/resources/Posters/76poster.pdf}
