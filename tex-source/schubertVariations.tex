...
The stable-limit ring and its single-alphabet basis have a separate page on
...
The single-alphabet basis, its ambient ring, and stable specializations are
described under \hyperref[backStableSchubert]{back stable Schubert polynomials}.
...
\subsection[macdonaldSeventhVariationSchur]{Macdonald's seventh-variation Schur polynomials}

Macdonald's seventh variation is a finite-field analogue of Schur functions
attached to subspaces of a vector space.  \name{Darij Grinberg} proves and
generalizes Macdonald's conjectured $V/L$ recursion, including a skew version
\cite{Grinberg2026x}.  The recursion separates subspaces according to whether
they contain a distinguished line, giving a finite-field counterpart of
branching recurrences for Schur polynomials.
