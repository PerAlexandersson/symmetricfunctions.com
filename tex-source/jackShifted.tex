...
was shown by \name{Friedrich Knop} and \name{Siddhartha Sahi} in \cite{KnopSahi1996} that $\jackShifted_\mu$ 
...
From the vanishing result by \name{Friedrich Knop} and \name{Siddhartha Sahi} \cite{KnopSahi1996} and a simple contradiction argument
...
and \filelink{files/jackStructureConstants6.m}{the data is available for download here (1.4Mb)}.
