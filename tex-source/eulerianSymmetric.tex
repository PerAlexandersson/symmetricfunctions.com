...
that is, it is the \hyperref[frobeniusCharacteristic]{Frobenus characteristic} of a 
...
The stronger statement, positivity in the complete homogenous basis, is not true.
For example, 
\[
...
\]
exhibits the \hyperref[cyclicSieving]{cyclic sieving phenomenon}, where $C_n$ act by conjugation.
...
These are believed to satisfy a cyclic sieving phenomena as above.
