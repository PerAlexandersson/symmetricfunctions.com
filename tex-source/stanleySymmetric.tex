...
The Stanley symmetric functions were introduced by R. Stanley in \cite{Stanley1984}.
...
In \cite{Hawkes2018}, an interpolaton of the type $A$ and type $C$ Stanley symmetric functions is introduced.
...
The affine Stanley symmetric functions were introduced by Thomas Lam in \cite{Lam2006}.
...
Let $\omega$ be an affine Grassman permutation, corresponding to $\lambda = \lambda(\omega)$,
...
introduced by E. Marberg and Y. Zhang 2018 in \cite{MarbergZhang2018}. 
It is expected that these are related to geometry of affine analogues of certain symmetric varieties.
...
An affine extension is introduced by Zhang \cite{Zhang2019}.
