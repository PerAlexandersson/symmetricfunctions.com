...
\cite{BergSaliolaSerrano2013}.  This places the strong Schur functions in
the same affine Schur and $k$-Schur picture.
...
\todo{Later relation pass: clarify whether strong Schur functions should be a separate family node or handled through affine Schur functions, and add examples of the affine nilCoxeter/Pieri-operator construction.}
