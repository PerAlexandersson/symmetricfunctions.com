...
A \defin{root ideal} $\Phi$ is an upper order ideal in
\[
...
A nice conjecture regarding the Katalan symmetric functions is solved in \cite{IkedaIwaoNaito2024}.
...
Several alternative definitions of $k$-Schur functions have since then surfaced, and not all
...
An alternative proof is given by \name{Seung Jin Lee} in \cite[Thm. 10.1]{Lee2015},
and in 2022, \name[D.-K. Nguyen]{Duc-Khanh Nguyen} \cite{Nguyen2022x} gave a 
proof in the more general setting, where a Murnaghan--Nakayama rule 
...
This implies that a modified Macdonald polynomial 
