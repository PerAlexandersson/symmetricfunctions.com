...
and partition $\mu$. This conjecture is resolved by \name[Jonah Blasiak]{J. Blasiak}, \name[Jennifer Morse]{J. Morse} and \name[Anna Pun]{A. Pun} in
...
\name{J. Bandlow}, \name[Anne Schilling]{A. Schilling} and \name[Mike Zabrocki]{M. Zabrocki}
...
and in 2022, \name{D.-K. Nguyen} \cite{Nguyen2022x} gave a proof in the more general setting,
...
\name{Syu Kato} \cite{Kato2025x} shows that Garcia--Haiman modules can be decomposed into certain modules 
