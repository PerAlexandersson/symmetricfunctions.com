...
argument.  Thus the Eulerian polynomials form a strict
\hyperref[sturmSequenceDefinition]{Sturm sequence} of
\hyperref[realRootedPolynomial]{real-rooted polynomials}.  Real-rootedness
implies log-concavity and unimodality of every Eulerian row.  By the
...
For a tableau-theoretic analogue, Lascoux's
\hyperref[lascouxTableauhedron]{tableauhedron} organizes key-polynomial
Hilbert numerators through a weighted Eulerian incidence matrix.  The
construction is a tableau/crystal graph rather than an established convex
polytope.
...
\hyperref[eulerianSymmetric]{Eulerian quasisymmetric-function page}.  A
\hyperref[ex:stableMultivariateEulerianOperator]{multivariate stable
refinement} gives another route to the real-rootedness theorem.
