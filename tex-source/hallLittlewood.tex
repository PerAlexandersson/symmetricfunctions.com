...
- PositiveIn hallLittlewoodP -> generalTAtom (current guess: hallLittlewoodP -> generalizedDemazureAtoms); from polynomialData.m.
- PositiveIn hallLittlewoodP -> tatom (current guess: hallLittlewoodP -> atom); from polynomialData.m.
}
