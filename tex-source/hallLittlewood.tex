...
\begin{polydata}{hallLittlewoodQ}
  ...
  Category & Schur \\
  SpecializesTo & schurS | Littlewood1961 | map=t=0 \\
  SpecializesTo & completeH | Littlewood1961 | map=t=1 \\
\end{polydata}

\todo{Legacy relation hints from old polynomialData.m/tikzdata*.txt to verify or migrate:
- SignedIn hallLittlewoodQ -> grothendieckDual (current guess: hallLittlewoodQ -> grothendieckDualStable); Link=https://hal.inria.fr/hal-01186288/document; from polynomialData.m, tikzdataPositivity.txt.
- PositiveIn hallLittlewoodQ -> schurS; from polynomialData.m, tikzdataPositivity.txt.
}
...
\todo{Legacy relation hints from old polynomialData.m/tikzdata*.txt to verify or migrate:
- Misc hallLittlewoodH -> hallLittlewoodQ; from polynomialData.m.
- Misc modHL -> hallLittlewoodQ (current guess: hallLittlewoodH -> hallLittlewoodQ); from tikzdataRelations.txt.
}
