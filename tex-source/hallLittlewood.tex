...
\todo{Later relation pass: decide whether $\imath$ Hall--Littlewood functions need a family node, then record the specializations to modified Hall--Littlewood functions and type $C$ universal characters. Add a small example.}
