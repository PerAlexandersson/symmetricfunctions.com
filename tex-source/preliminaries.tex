...
\begin{figure}
\svgimg[width=0.95\textwidth]{./svg-images/ssytRowLatticePaths.svg}{SSYT rows as lattice paths.}  
\end{figure}
...
\begin{figure}
  \svgimg[width=0.95\textwidth]{./svg-images/ssytColumnLatticePaths.svg}{SSYT columns as lattice paths.}
\end{figure}
\end{example}
