...
\name{Bruce Sagan} and \name{Richard Stanley} consider a skew extension of RSK 
...
In \cite{Pahuja2026x}, the author considers the set of matrices that map to 
a fixed shape $\lambda$ under RSK. In this set, there are matrices with the minimal number of inversions
(computed from the second row in the biword). The author conjectures a characterization of 
these \emph{minimal matrices}, namely that these are symmetric Hankel matrices.
