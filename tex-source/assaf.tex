...
\todo{Legacy relation hints from old polynomialData.m/tikzdata*.txt to verify or migrate:
- PositiveIn fundamentalParticle -> monomialNonsymmetric (current guess: slideF -> monomial); Link=https://arxiv.org/pdf/1707.01172.pdf; from polynomialData.m, tikzdataPositivity.txt.
- PositiveIn fundamentalSlide -> fundamentalParticle (current guess: slideF -> slideF); Link=https://arxiv.org/pdf/1707.01172.pdf; from polynomialData.m, tikzdataPositivity.txt.
}
