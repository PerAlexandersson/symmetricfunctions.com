...
were introduced by \name[Sami Assaf]{S. Assaf} and \name[Dominic Searles]{D. Searles} in \cite{AssafSearles2016}.
The slide polynomials form a basis for the space of polynomials, and can be seen as a lift 
...
Lock polynomials were introduced by \name[Sami Assaf]{S. Assaf} and \name[Dominic Searles]{D. Searles} in \cite{AssafSearles2019}.
...
explored by \name[George Wang]{G. Wang} in \cite{Wang2020}.
