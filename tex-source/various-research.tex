...
\section[personalMinorProblems]{Minor problems}
...
a certain union of faces in a \hyperref[gtpolytopes]{Gelfand--Tsetlin polytope}.
...
This was posted on \href{https://mathoverflow.net/questions/330620/q-analogue-of-an-inequality}{MathOverflow},
...
\]
Show that $T_\lambda(\xvec)$ is \hyperref[schurPositivity]{Schur-positive}.
...
the conjecture by \name{Werner Schulte}, Oct 23 2016.


\subsection[schubertCharge]{Schubert charge}

The Schubert polynomials generalize the Schur polynomials,
so for Grassmannian permutations there should be a bijection
from pipe dreams to SSYT.
...
See
\href{https://mathoverflow.net/questions/251560/combinatorial-characterization-of-intersecting-intervals-in-the-plane}{this
...
and \name{Vasu Tewari} pointed out the straightforward proof presented below.
\begin{proposition}
Let $\delta_n$ be the staircase partition $(n,n-1,\dotsc,1,0)$.
Consider the Schur polynomial indexed by the stretched staircase,
\[
