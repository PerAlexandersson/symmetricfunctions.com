...
- SpecializesTo permBasMacdonaldE -> generalAtom (current guess: macdonaldEperm -> generalizedDemazureAtoms); from polynomialData.m, tikzdataRelations.txt.
- SpecializesTo permBasMacdonaldE -> generalTAtom (current guess: macdonaldEperm -> generalizedDemazureAtoms); from polynomialData.m.
}
