...
\[
\jackJ_{31}(x;a) =
(2a^2 + 4a + 2)\monomial_{31}+(6a + 10)\monomial_{211}
+(4a + 4)\monomial_{22}+ 24\monomial_{1111}.
\]
...
power-sum symmetric functions is given. It is not cancellation-free in general.
...
\[
R_{\lambda,\mu}(z) = \sum_{k=0}^{n} b_k(\mu,\lambda) z^k \qquad
...
Lassalle conjectured that Jack characters satisfy a certain positivity
property \cite{Lassalle2008}. This was proved by
