...
\[
 ...
 \sum_{k=0}^{n} b_{n-k}(\mu,\lambda) \binom{a}{k} k!
\]
and define the \defin{Jack rook polynomial} $R_{\lambda,\mu}(z)$
and the \defin{Jack hit polynomial} $H_{\lambda,\mu}(z)$ as
\[
...
Then the \defin{Jack character} (introduced in
