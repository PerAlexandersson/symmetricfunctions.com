...
\name{Lin Jiu} and \name{Christoph Koutschan} give algorithms and
implementation details for calculating zonal polynomials
\cite{JiuKoutschan2020}.
...
and $\{i,j\} \in S_c$ if and only if edges $i$ and $j$ share a vertex
with color $c \in \{1,2\}$.
