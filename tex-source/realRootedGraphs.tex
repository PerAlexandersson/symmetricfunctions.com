...
\name{Ferenc Bencs} gives another proof using Christoffel--Darboux type
identities for independence polynomials \cite{Bencs2014}; this route is also
useful for proving interlacing statements via Wronskian inequalities.
