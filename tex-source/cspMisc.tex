...
the rowmotion operator (a.k.a. the \enquote{Fon-Der-Flaass/Panyushev map}) on
the \hyperref[antichain]{antichains} of $\Phi^+$.
...
In \cite{RushShi2012}, the authors consider rowmotion acting on the
\hyperref[antichain]{antichains} of minuscule posets.
