...
the \hyperref[rowmotion]{rowmotion} operator (a.k.a. the
...
In \cite{AdamsBanian2025x}, the authors prove a CSP for
...
\name{Brendon Rhoades} further generalizes this to matrices with non-negative 
...
the $q$-analog of the \hyperref[ehrhart]{Ehrhart function} of $P$, defined as
\[
