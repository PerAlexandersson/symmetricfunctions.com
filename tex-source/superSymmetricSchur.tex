...
\todo{Later relation and examples pass: decide whether multi-Schur and Littlewood--Schur functions need separate polydata nodes. Add small hook/tableau examples, preferably generated or checked by Rust code.}
