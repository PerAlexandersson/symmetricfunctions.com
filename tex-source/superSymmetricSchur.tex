...
% Related Rust: sym-poly/sym/examples/hook_schur_site_example.rs
...
Macdonald's ninth variation for the $P$/$Q$ setting, and include ordinary
Schur $P$/$Q$-functions, factorial $P$/$Q$-functions, and the $t=-1$
specializations of Hall--Littlewood functions for classical root systems.
...
\todo{Later relation pass: decide how to model Macdonald's ninth variation and the generalized Schur $P$/$Q$ functions in polydata. Add a small Pfaffian or ninth-variation tableau example if feasible.}
