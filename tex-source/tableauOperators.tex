...
Promotion can be defined on linear extensions of posets, see \name{Richard Stanley}
\cite{Stanley2009}.  \name{Colin Defant} and \name{Noah Kravitz} generalize this
to arbitrary poset labelings through promotion sorting \cite{DefantKravitz2022}.
