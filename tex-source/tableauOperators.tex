...
Note however that the $BK_i$ \emph{do not} satisfy the \hyperref[braidRelations]{braid relations}!
...
In \cite[Lem.~3.2]{DoranIV1997}, it is shown that jeu-de-taquin preserves the descent set.
