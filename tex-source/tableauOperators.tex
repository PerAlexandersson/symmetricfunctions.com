...
For the word $w=213$, ordinary row insertion gives the following successive
tableaux.
\begin{figure}
\ytableaushort{2}
\ytableaushort{1,2}
...
anti-diagonal skew shape from the theorem above and rectifying the first
tableau below to the second.
\begin{figure}
\ytableaushort{{\none}{\none}3,{\none}1,2}
\ytableaushort{13,2}
\end{figure}
...
The \hyperref[posetPromotion]{poset version of promotion} acts on
\hyperref[linearExtension]{linear extensions} and specializes to the tableau
