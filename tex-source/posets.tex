...
Jordan--Hölder set of the labeled poset $(P,w)$ is
\[
  \mathcal{L}(P,w)
  \coloneqq
...
is the bridge between linear extensions, descent statistics, and
\hyperref[posetRealRooted]{real-rootedness questions for posets}.  A famous
question in this direction was the
