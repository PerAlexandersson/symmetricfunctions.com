...
\metadescription{K-theoretic analogues of Schur P and Schur Q functions, introduced by Ikeda and Naruse, with properties and Littlewood-Richardson rules.}
...
polynomial analogues for fixed-point-free involutions 
expand positively into GP_lambda's and conjectured that 
analogues for arbitrary involutions expand positively into GQ_lambda's (they proved this in the vexillary case).
}

\todo{Add more info on these polynomials.}
...
In \cite{IkedaNaruse2013}, Ikeda and Naruse introduce $K$-theoretic analogues of the \hyperref[schurP]{Schur $P$}
...
These are $K$-theoretic analogues of $\schurP_{\lambda}(\xvec)$ and  $\schurQ_{\lambda}(\xvec)$.
