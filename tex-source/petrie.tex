...
The \emph{Petrie symmetric functions} are a family of symmetric functions indexed by
two non-negative integers. 
This family is the main topic in the work by \name{Darij Grinberg} \cite{Grinberg2020x,Grinberg2020}.
They are also studied independently by \name{Houshan Fu} and \name{Zhousheng Mei} \cite{FuMei2020}
