...
\todo{Later examples pass: add a small orbit-harmonics/plethysm example for $a=2$ or $3$; consider Rust code to verify the Schur expansions before writing them.}
