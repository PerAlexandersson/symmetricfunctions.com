...
\href{http://garsia.math.yorku.ca/ghana03/chapters/mainfile3.pdf}{\name{Mike Zabrocki}'s introduction to symmetric functions, Chapter III}.
...
algebra, also called the party algebra \cite{OrellanaSaliolaSchillingZabrocki2022Party}.
...
The following properties uniquely define \defin{plethysm} where $f$, $g$ and $h$ denote symmetric functions
...
in fact a specialization of the \hyperref[grothendieckCanonical]{canonical stable Grothendieck polynomial}:
\[
