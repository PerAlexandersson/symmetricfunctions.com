...
\metadescription{An introduction to representation theory, including general definitions, irreducible representations, tensor products, characters, and specific focus on the representation theory of the symmetric group $\symS_n$ and the general linear group $\GL_n$.}

\section[general-representation-theory]{General representation theory}
